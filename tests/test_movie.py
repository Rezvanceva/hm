...
def movie_dao():
    ...
    movie_1 = Movie(id=1, title='title_1', description='asasfasf', trailer="1asd", year=2020, rating=20.1, genre_id=1,
                    director_id=1)
    movie_2 = Movie(id=2, title='title_2', description='asasfasf', trailer="1asd", year=2020, rating=20.1, genre_id=2,
                    director_id=2)
